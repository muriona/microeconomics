...
\left\langle
\begin{bmatrix}
-D_1(d_1) - d_1\ \frac{\partial D_1(d_1)}{\partial d_1} + S_1(q_1)+C{11} \\
. \\
.\\
.\\
-D_j(d_j) - d_j\ \frac{\partial D_j(d_j)}{\partial d_j} + S_i(q_i)+C{ij}\\
.\\
.\\
.\\
-D_1(d_n) - d_n\ \frac{\partial D_n(d_n)}{\partial d_n} + S_m(q_m)+C{mn}
\end{bmatrix}
,
\begin{bmatrix}
x_{11}^*\\
...
- Seguindo a notação da gradiente $- \nabla\ z(ij) = $ $-D_j(d_j) - d_j\ \frac{\partial D_j(d_j)}{\partial d_j} + S_i(q_i)+C{ij}$ precisamos definir o termo $d_j\ \frac{\partial D_j(d_j)}{\partial d_j}$:
