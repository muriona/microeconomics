...
- Ou seja, o valor ótimo de consumo é 250 unidades de utilidade e as quantidades de $x=10$ e $y=10$ unidades respectivamente. 

- Será neste ponto que ambas as curvas encontrar-se-ão:

```{r echo = FALSE, fig.height=4, fig.width=4, warning=FALSE, fig.align='center'}
ggplot() + 
  # Budget line
  stat_function(data = tibble(x = 0:15), aes(x = x),
                fun = budget, color = "#638ccc", size = 1.5) +
  annotate(geom = "label", x = 2.5, y = budget(2.5), 
           label = "R.O.", color = "#638ccc") +
